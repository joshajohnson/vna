...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, ATTEN_MOSI_Pin|ATTEN_CLK_Pin|MAX2871_CHIP_EN_Pin|MAX2871_LE_Pin 
                          |FLASH_nWP_Pin|ATTEN_MOSIC10_Pin|ATTEN_CLKC11_Pin|ATTEN_LE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, MAX2871_LD_Pin|FLASH_nCS_Pin|FLASH_nHOLD_Pin|USB_PULLUP_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ATTEN_MOSI_Pin|ATTEN_CLK_Pin|MAX2871_CHIP_EN_Pin|MAX2871_LE_Pin 
                          |FLASH_nWP_Pin|ATTEN_MOSIC10_Pin|ATTEN_CLKC11_Pin|ATTEN_LE_Pin;
  ...
  GPIO_InitStruct.Pin = MAX2871_LD_Pin|FLASH_nCS_Pin|FLASH_nHOLD_Pin|USB_PULLUP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = MAX2871_RF_EN_Pin|TEST_POINT_1_Pin|TEST_POINT_2_Pin;
