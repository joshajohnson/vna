...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\linewidth]{assembledVNA.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{phase_correction.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\linewidth]{vna_errors.png}
